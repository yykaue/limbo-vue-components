        ...
        >
          ...
          <template v-if="item.type === 'input'">
            <el-input
              ...
              :placeholder="checkDefault(item, ['contentAttrs', 'placeholder'], `${translate('form.pleaseEnter')}${item.name}`)"
          ...
          <template v-else-if="item.type === 'select'">
            <el-select
              ...
              :placeholder="checkDefault(item, ['contentAttrs', 'placeholder'], `${translate('form.pleaseSelect')}${item.name}`)"
          ...
          <template v-else-if="item.type === 'dateTimePicker' ">
            <el-date-picker
              ...
              :range-separator="checkDefault(item, ['contentAttrs', 'rangeSeparator'], translate('form.rangeSeparator'))"
              :start-placeholder="checkDefault(item, ['contentAttrs', 'startPlaceholder'], translate('form.startDate'))"
              :end-placeholder="checkDefault(item, ['contentAttrs', 'endPlaceholder'], translate('form.endDate'))"
              :placeholder="checkDefault(item, ['contentAttrs', 'placeholder'], `${translate('form.pleaseSelect')}${item.name}`)"
          ...
          <!--default-->
          <template v-else>
            <span>{{ translate('form.unknownType') }}</span>
          </template>
        </el-form-item>
      </el-col>
      <el-col
          ...
          <slot>
            <div :class="formItem.btnObj.className">
              <el-button
                ...
                @click="search"
              >
                {{ checkDefault(formItem.btnObj, ['searchName'], translate('form.search')) }}
              </el-button>
              <el-button
                v-if="!formItem.btnObj.showList || formItem.btnObj.showList.includes('reset')"
                @click="reset"
              >
                {{ checkDefault(formItem.btnObj, ['resetName'], translate('form.reset')) }}
              </el-button>
            </div>
          </slot>
        </el-form-item>
